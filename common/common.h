...
// runs every thread on the NUMA node of the GPUs the model uses, if the host has more nodes (Linux); common_init_from_params undoes it when layers stay on the CPU
