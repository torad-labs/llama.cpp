...
// TMA rings: ggml_cuda_mmvq_pq2_mma. It takes the operands mul_mat_vec_q takes (vy is src1 quantized to q8_1,
...
// weights 16-byte aligned, and the stream's tile counters held (allocated here outside a graph capture).
