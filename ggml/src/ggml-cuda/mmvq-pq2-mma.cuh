...
// PQ2_0 x q8_1 at 1-8 columns (decode and an MTP verify's rows) on int8 tensor cores, weights streamed through per-warp
// TMA rings:
...
// Whether the kernel serves this matmul: GeForce / RTX PRO Blackwell (sm_120, not yet measured on GB10's sm_121) built for
// it, 1-8 columns, K a multiple of 1024 (every row a whole number of 16-byte TMA units), the weights 16-byte aligned.
