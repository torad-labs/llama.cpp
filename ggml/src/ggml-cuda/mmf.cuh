...
bool ggml_cuda_should_use_mmf(enum ggml_type type, int cc, int warp_size, const int64_t * scr0_ne, const size_t * src0_nb,
        const size_t * src1_nb, const int src1_ncols, bool mul_mat_id);
